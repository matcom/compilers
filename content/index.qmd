...
Pipeline(['HULK', 'Parser', 'Generador', 'MIPS'], [
    (0, 1, ""),
    (1, 2, ""),
    (2, 3, ""),
...
Pipeline(['HULK', 'Parser', 'Semántico', 'Generador', 'MIPS'], [
    (0, 1, ""),
    (1, 2, ""),
    (2, 3, ""),
    (3, 4, ""),
], startshape='plaintext', endshape='plaintext').print(width="100%", float=False)
```
...
Lexer('i f \\\\s ( a < = 0 ) \\\\n \\\\t b \\\\n e l s e \\\\n \\\\t c \\\\n'.split()).print(float=False, width="100%")
```
...
Lexer('if ( a <= 0 ) b else c'.split()).print(float=False, width="45%")
```
...
Pipeline(['HULK', 'Lexer', 'Parser', 'Semántico', 'Generador', 'MIPS'], [
    (0, 1, ""),
    (1, 2, ""),
    (2, 3, ""),
    (3, 4, ""),
