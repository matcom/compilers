...
# Veamos el árbol de derivación (_déjalo en pizarra!_)
...
# Computando el valor de los atributos (_en pizarra_)
...
**Pregunta interesante:** ¿Se puede determinar a partir de la gramática si en todo árbol de derivación necesariamente tendremos un DAG?
...
# Evaluando atributos en el árbol de derivación

- Los atributos **heredados** se evalúan top-down, left-to-right
- Los atributos **sintetizados** se evalúan bottom-up

## ¿Se puede hacer en un solo recorrido?
...
> - Nuevamente repetimos el patrón de resolver un problema diseñando un lenguaje declarativo de alto nivel y un mecanismo de bajo nivel que se construye automáticamente del lenguaje.
> - En LL es posible evaluar las reglas semánticas durante el propio proceso de parsing, pero es horriblemente tortuoso. Ya veremos cuando lleguemos a LR.
> - Las reglas semánticas sirven para mucho más que evaluar expresiones aritméticas.





**Pregunta interesante:** ¿Existen lenguajes decidibles que no se puedan definir con gramáticas libres del contexto atributadas?
