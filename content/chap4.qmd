...
```python
class LetVar(Statement):
    def __init__(self):
        self.identifier: str = ""
        self.expr: Expression = None

class DefFunc(Statement):
    def __init__(self):
        self.identifier: str = ""
...
class IContext(ABC):
    ...
    @abstractmethod
    def is_defined(self, function: str, args: int) -> bool:
        ...

    @abstractmethod
    def define(self, variable: str) -> bool:
        ...

    @abstractmethod
    def define(self, function: str, args: list[str]) -> bool:
        ...
```
...
class FuncCall(Expression):
    ...
    def validate(self, context: IContext) -> bool:
        ...
        return context.is_defined(self.identifier, len(self.args))
```
...
class LetVar(Statement):
    ...
    def validate(self, context: IContext) -> bool:
        ...
        if not context.define(self.identifier):
            return False
...
class Context(IContext):
    ...
    def is_defined(self, variable: str) -> bool:
        return variable in self.variables or (
            self.parent is not None and self.parent.is_defined(variable)
        )

    def is_defined(self, function: str, args: int) -> bool:
        if function in self.functions and len(self.functions[function]) == args:
            return True
        return self.parent is not None and self.parent.is_defined(function, args)
    ...
    def define(self, function: str, args: list[str]) -> bool:
        if function in self.functions and len(self.functions[function]) == len(args):
            return False
